...
public enum GuiceyLifecycle {
    ...
    /**
     * Called after
     * {@link ru.vyarus.dropwizard.guice.GuiceBundle#run(io.dropwizard.core.Configuration, io.dropwizard.core.setup.Environment)}
     ...
     * {@link io.dropwizard.core.Application#run(io.dropwizard.core.Configuration, io.dropwizard.core.setup.Environment)}. Ideal point
